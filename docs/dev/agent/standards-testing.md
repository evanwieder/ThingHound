...
2. Integration tests use a real in-memory SQLite database. Never mock the database layer.
...
10. Sync tests create two real in-memory databases, exchange changesets, and verify merged state satisfies all invariants.
